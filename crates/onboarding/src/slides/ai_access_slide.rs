...
use warpui_core::elements::{
    Border, ClippedScrollStateHandle, Container, CornerRadius, CrossAxisAlignment,
    Flex, FormattedTextElement, Hoverable, MainAxisSize, MouseStateHandle,
...
/// The "AI access" onboarding step. Heddle ships without hosted inference, so
/// this step simply tells the user that AI is bring-your-own-provider and can
/// be configured later.
...
impl AiAccessSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let subtitle = FormattedTextElement::from_str(
            "Heddle uses your own AI provider. You can connect an API key or a CLI \
             agent now, or set it up later.",
    ...
    fn render_set_up_later_card(
        ...
        let description = FormattedTextElement::from_str(
            "Continue for now and connect your own AI provider or CLI agent from \
