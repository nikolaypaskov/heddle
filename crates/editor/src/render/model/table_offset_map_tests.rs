...
fn test_table_cell_offset_map_handles_bold_and_links() {
    let source = "**Bold** [Link](https://github.com/nikolaypaskov/warp#readme)";
    ...
    assert!(
        inline
            .iter()
            .any(|fragment| matches!(&fragment.styles.hyperlink, Some(Hyperlink::Url(url)) if url == "https://github.com/nikolaypaskov/warp#readme")),
