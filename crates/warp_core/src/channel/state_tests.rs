...
fn wss_becomes_https_and_strips_path() {
    ...
    assert_eq!(got.as_deref(), Some("https://github.com/nikolaypaskov/warp#readme"));
}
...
fn unparseable_input_returns_none() {
    ...
    assert!(derive_http_origin_from_ws_url("https://github.com/nikolaypaskov/warp#readme").is_none());
}
