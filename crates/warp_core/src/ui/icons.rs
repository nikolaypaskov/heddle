...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::Warping0 => "bundled/svg/heddle-spinner-0.svg",
            Icon::Warping1 => "bundled/svg/heddle-spinner-1.svg",
            Icon::Warping2 => "bundled/svg/heddle-spinner-2.svg",
            Icon::Warping3 => "bundled/svg/heddle-spinner-3.svg",
            Icon::Warping4 => "bundled/svg/heddle-spinner-4.svg",
            Icon::Warping5 => "bundled/svg/heddle-spinner-5.svg",
            Icon::Warping6 => "bundled/svg/heddle-spinner-6.svg",
            Icon::Warping7 => "bundled/svg/heddle-spinner-7.svg",
            Icon::Warping8 => "bundled/svg/heddle-spinner-8.svg",
            Icon::Warping9 => "bundled/svg/heddle-spinner-9.svg",
            Icon::Warping10 => "bundled/svg/heddle-spinner-10.svg",
            Icon::Warping11 => "bundled/svg/heddle-spinner-11.svg",
            ...
            Icon::OzCloud => "bundled/svg/agent-cloud.svg",
