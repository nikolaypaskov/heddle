...
pub fn init(app: &mut AppContext) {
        ...
        #[cfg(debug_assertions)]
        {
            ...
            app.register_editable_bindings([
                ...
                EditableBinding::new(
                    ...
                    "[Debug] Install the OpenCode plugin",
                    WorkspaceAction::InstallOpenCodeWarpPlugin,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:use_local_opencode_warp_plugin",
                    "[Debug] Use the local OpenCode plugin (testing only)",
    ...
    // `workspace:log_out` is deliberately not registered: there is no session to end. Leaving
    // it registered would keep it listed in the keyboard-shortcuts page as a bindable command
    ...
    #[cfg(target_os = "macos")]
    {
        app.register_editable_bindings([
            EditableBinding::new(
                ...
                "Install the CLI globally for use outside of Heddle",
            ...
            EditableBinding::new(
                ...
                "Undo global CLI installation (it will still work within Heddle)",
        ...
        if FeatureFlag::WarpControlCli.is_enabled() {
            app.register_editable_bindings([
                EditableBinding::new(
                    ...
                    "Install Heddle Control CLI globally for use outside of Heddle",
                ...
                EditableBinding::new(
                    ...
                    "Undo global Heddle Control CLI installation (warpctrl will still work within Heddle)",
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About Heddle"),
