        ...
        match action {
            ...
            ConversationListViewAction::ToggleOverflowMenu {
                ...
                if is_open_for_same_conversation {
                    ...
                    // "Share conversation" is gone. It published the conversation to Warp
                    // Drive and produced a warp.dev link; there is no destination for it here.
                    // The conversation list itself is local and untouched.
