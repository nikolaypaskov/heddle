...
impl Slide for OzLaunchSlide {
    ...
    fn content(&self) -> &'static str {
        match self {
            ...
            OzLaunchSlide::AgentManagement => {
                "View all of your agents across local and cloud sessions. Join live agent sessions, continue tasks locally, and steer agents with one click."
            }
            OzLaunchSlide::LaunchCredits => {
    ...
    fn image(&self) -> AssetSource {
        ...
        match self {
            OzLaunchSlide::CloudAgents => {
                bundled_or_fetched_asset!("svg/heddle-mark.svg")
            }
            OzLaunchSlide::AgentAutomations => {
                bundled_or_fetched_asset!("svg/heddle-mark.svg")
            }
