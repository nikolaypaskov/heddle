    ...
    App::test((), |app| async move {
        app.read(|ctx| {
            ...
            let block_index = insert_block(
                &mut block_list,
                "echo https://github.com/nikolaypaskov/warp#readme hello/world.js\n",
            ...
            assert_eq!(
                ...
                Some("https://github.com/nikolaypaskov/warp#readme".to_string())
            );
...
fn test_smart_selection_in_multiple_blocks() {
    App::test((), |app| async move {
        ...
        block_list.selection_to_string(&semantic_selection, false, ctx),
        Some(
            "hello/world.js\nhttps://github.com/nikolaypaskov/warp#readme hello/world.js\necho 192.168.0.1\n192.168"
                .to_string()
        )
    );
            block_list.clear_selection();
...
fn test_smart_selection_override() {
    App::test((), |app| async move {
        app.read(|ctx| {
            ...
            let block_index = insert_block(
                &mut block_list,
                "echo https://github.com/nikolaypaskov/warp#readme hello/world",
                "https://github.com/nikolaypaskov/warp#readme",
            );

            // the override wraps "https://github.com/nikolaypaskov/warp#readme"
