...
const TERMS_URL: &str = "https://github.com/nikolaypaskov/warp#readme";
const TERMS_CONTACT_TEXT: &str =
    " If you have any questions about the referral program, please open an issue at https://github.com/nikolaypaskov/warp/issues.";
