...
lazy_static! {
    ...
    pub static ref MAC_PTY_NON_COMPLIANT_ACTIONS: HashSet<&'static str> = HashSet::from_iter(["terminal:heddlify_subshell", "terminal:open_block_list_context_menu_via_keybinding"]);
